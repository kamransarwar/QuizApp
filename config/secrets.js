...
module.exports = {
  ...
  db: 'mongodb://localhost:27017/quizapp',

  sessionSecret: process.env.SESSION_SECRET || 'mynicknameiskami',

  sendgrid: {
    user: process.env.SENDGRID_USER || 'malik.kamran.sarwar',
    password: process.env.SENDGRID_PASSWORD || 'K@mran123'
  },
